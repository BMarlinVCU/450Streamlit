...
st.title("📊 Advertising Effectiveness by City")

# You can scale bubbles by TV spend or Sales
fig = px.scatter_mapbox(
    df,
    lat="latitude",
    lon="longitude",
    color="sales",
    size="TV",  # try "Radio" or "Newspaper" instead
    hover_name="City",
    hover_data={"latitude": False, "longitude": False, "TV": True, "sales": True},
    color_continuous_scale=px.colors.carto.Temps,
    size_max=25,
    zoom=3,
    title="Advertising Sales by City",
)

fig.update_layout(
    mapbox_style="carto-positron",  # alternatives: "open-street-map", "carto-darkmatter", "stamen-terrain"
